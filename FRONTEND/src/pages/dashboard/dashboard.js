      ...
      <div className="nav_dashboard_izq">
        ...
        <div className="opcions_contain">
          <div className="layers_dash">
            ...
            <h2 className="layers_dash_opcions" id="balance_dash">
              Balance
            </h2>
            <h2 className="layers_dash_opcions" id="trans_dash">
              Transacciones
            </h2>
            <h2 className="layers_dash_opcions" id="groups_dash">
              Grupos
            </h2>
            <h2 className="layers_dash_opcions" id="sus_dash">
              Suscripciones
            </h2>
          </div>
          <div className="config_dash">
            <h2 className="config_dash" id="opcion_config_dash">
              Configuración
            </h2>
            <h2 className="config_dash" id="cerrar_ses">
              Cerrar Sesion
            </h2>
          </div>
        </div>
