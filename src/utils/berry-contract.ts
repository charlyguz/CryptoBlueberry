...
export type GroupWithPlan = Group & {
...
export const createProvider = async (
  berry: Berry,
  ...createProviderArgs: Parameters<Berry["createProvider"]>
) => {
...
export const createPlan = async (
  berry: Berry,
  ...planArgs: Parameters<Berry["addPlan"]>
) => {
...
export const register = async (
  berry: Berry,
  userAccount: Signer,
  ...registerArgs: Parameters<Berry["register"]>
) => {
...
export const createGroup = async (
  berry: Berry,
  ...createGroupArgs: Parameters<Berry["createGroup"]>
) => {
...
export const joinGroup = async (
  berry: Berry,
  ...joinGroupArgs: Parameters<Berry["joinGroup"]>
) => {
...
export const getAllProviders = async (berry: Berry) => {
  ...
  return Promise.all(
    Array.from(
      ...
      async (_, providerID) => await berry.providers(providerID)
    )
  );
};
...
export const getProviderPlans = async (
  ...
  return Promise.all(
    Array.from(
      { length: providerNumPlans },
      async (_, planID) => await berry.plansPerProvider(providerID, planID)
    )
  );
};
...
export const getGroupsPerPlan = (
  allGroups: Awaited<ReturnType<typeof getAllGroups>>
) => {
...
export const getAllPlans = async (
  berry: Berry,
  allProviders: Awaited<ReturnType<typeof getAllProviders>>
) => {
  return (
    await Promise.all(
      allProviders.map(
        async (serviceProvider) =>
          await getProviderPlans(berry, serviceProvider.providerID)
      )
    )
  ).flat();
};
